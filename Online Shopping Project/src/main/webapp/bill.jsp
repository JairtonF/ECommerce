...
<h3>Joyeria Acessórios Online</h3>
<hr>
...
<div class="right-div-right"><h3>Método de Pagamento: <%=rs2.getString(23)%> </h3></div>
...
<div class="right-div"><h3>Endereço: <%=rs2.getString(16)%> </h3></div> 

<div class="left-div"><h3>Estado: <%=rs2.getString(18)%> </h3></div>
<div class="right-div-right"><h3>País: <%=rs2.getString(19)%> </h3></div>  
